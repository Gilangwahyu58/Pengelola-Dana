...
class PengKemajuanScreen(Screen):
    def __init__(self, **kwargs):
        super(PengKemajuanScreen, self).__init__(**kwargs)
    ...
    def load_kemajuan_data(self, nama_desa):
        ...
        try:
            ...
            for kemajuan in kemajuan_data:
                ...
                button.bind(on_release=self.open_kemajuan_screen)
    ...
    def open_kemajuan_screen(self, button):
        """Logika untuk membuka layar edit dengan judul yang sesuai."""
        app = App.get_running_app()
        app.root.get_screen('user_kemajuan').usage_title = button.text
        app.root.current = 'user_kemajuan'