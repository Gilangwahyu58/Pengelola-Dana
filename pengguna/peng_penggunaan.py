...
class PengPenggunaanScreen(Screen):
    def __init__(self, **kwargs):
        super(PengPenggunaanScreen, self).__init__(**kwargs)
    ...
    def load_penggunaan_data(self, nama_desa):
        ...
        try:
            ...
            for penggunaan in penggunaan_data:
                ...
                button.bind(on_release=self.open_penggunaan_screen)  # Menghubungkan klik tombol ke metode
    ...
    def open_penggunaan_screen(self, button):
        """Logika untuk membuka layar edit dengan judul yang sesuai."""
        app = App.get_running_app()
        app.root.get_screen('user_penggunaan').usage_title = button.text
        app.root.current = 'user_penggunaan'
